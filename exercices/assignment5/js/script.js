...
$(document).ready(function(){
  $('#score').html("Click on the right answer or say I THINK IT'S followed by your guess<br>Say SAY IT AGAIN to repeat the word to guess<br>Say I GIVE UP if you can't find the word");
